 ...
 * {@code SAYONORA_LLM_QWEN_MODEL_PATH}/{@code SAYONORA_LLM_GEMMA_MODEL_PATH} override the default,
...
public final class LocalModelPresets {
    ...
    public static Preset qwen() {
        ...
        String path = System.getenv().getOrDefault("SAYONORA_LLM_QWEN_MODEL_PATH",
    ...
    public static Preset gemma() {
        String home = System.getProperty("user.home");
        String path = System.getenv().getOrDefault("SAYONORA_LLM_GEMMA_MODEL_PATH",
