 ...
 * constructor, same Gson-friendly shape {@link com.sayonora.dms.core.ConnectionRecord} uses
 * elsewhere in this module, deserialized straight off the request body.
 *
 * <p>{@code targetConnectionId} and the {@code warpGrpc*} fields are deliberately separate:
 * the former is a saved {@link com.sayonora.dms.core.ConnectionRecord} pointing at the TARGET
 ...
 * latter is the actual Warp gRPC endpoint every real data write goes through. Two different
 * things a real deployment usually points at the same physical Postgres, but Advisor has no
 * existing concept of "a Warp instance" as a saved entity, only "a Postgres connection" --
...
public class MigrationJobRequest {
    ...
    public String warpGrpcHost;
    public int warpGrpcPort;
    public String warpGrpcUser;
    public String warpGrpcPassword;
