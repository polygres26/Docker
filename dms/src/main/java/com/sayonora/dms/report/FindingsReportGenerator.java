package com.sayonora.dms.report;

import com.sayonora.dms.catalog.CatalogSnapshot;
import com.sayonora.dms.core.ConnectionRecord;
import com.sayonora.dms.score.MigrationScorer.MigrationScoreReport;
import com.sayonora.dms.score.MigrationScorer.ScoreFinding;
...
public class FindingsReportGenerator {
    ...
    public byte[] generate(ConnectionRecord connection, CatalogSnapshot snapshot, MigrationScoreReport score) throws IOException {
        try (PDDocument document = new PDDocument()) {
            ...
            w.heading("Sayonora Advisor -- Migration Assessment", 20);
