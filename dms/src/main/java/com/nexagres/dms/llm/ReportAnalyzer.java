 ...
 * com.nexagres.dms.score.MigrationScorer} et al.) -- there's no live database to query
 ...
 * {@link com.nexagres.dms.sizing.SizingCalculator} for the report-based sizing flow, the same
