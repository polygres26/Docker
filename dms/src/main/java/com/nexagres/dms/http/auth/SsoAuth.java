 ...
 * internal IdP) rather than provisioning a NexaGres-specific password for every admin.
 *
 * <p>Deliberately scoped to HS256 (a shared signing secret, {@code NEXAGRES_SSO_JWT_SECRET}) for
...
public final class SsoAuth {
     ...
     *     System.getenv("NEXAGRES_SSO_JWT_SECRET").getBytes(StandardCharsets.UTF_8)}
