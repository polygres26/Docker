...
import com.nexagres.dms.llm.LlmSettingsStore;
import com.nexagres.dms.llm.ReportAnalyzer;
import com.nexagres.dms.sizing.SizingCalculator;
import com.nexagres.dms.sizing.SizingInput;
import com.nexagres.dms.uploads.HtmlTextExtractor;
import com.nexagres.dms.uploads.ReportStore;
import com.nexagres.dms.uploads.UploadedReport;
 ...
 * /api/connections} entirely: no {@link com.nexagres.dms.core.BackendTarget}, no live
 * database, no {@link com.nexagres.dms.score.MigrationScorer} -- findings here come from
