...
import com.nexagres.dms.core.DmsLicensing;
 ...
 *
 * <p>Admin credentials: {@code NEXAGRES_ADMIN_USER} (default {@code admin}) and
 * {@code NEXAGRES_ADMIN_PASSWORD}. If the password env var is unset, a random one is generated at
 ...
 *
 * <p>Viewer credentials: {@code NEXAGRES_VIEWER_USER}/{@code NEXAGRES_VIEWER_PASSWORD}, both
...
public class AdminAuth {
    ...
    public AdminAuth(AuditLogStore auditLog) {
        this(auditLog,
                System.getenv().getOrDefault("NEXAGRES_ADMIN_USER", "admin"),
                System.getenv("NEXAGRES_ADMIN_PASSWORD"),
                System.getenv("NEXAGRES_VIEWER_USER"),
                System.getenv("NEXAGRES_VIEWER_PASSWORD"));
    }
    ...
    AdminAuth(AuditLogStore auditLog, String adminUser, String configuredAdminPassword,
        ...
        if (configuredAdminPassword == null || configuredAdminPassword.isBlank()) {
            ...
            log.warn("NEXAGRES_ADMIN_PASSWORD not set -- generated a one-time password for this "
                + "process. Set NEXAGRES_ADMIN_PASSWORD explicitly for anything beyond local dev. "
