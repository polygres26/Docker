...
/**
 * The paid/free line for NexaGres DMS's own admin-console features -- the RBAC/audit/SSO row of
 ...
 *   console, so {@link com.nexagres.dms.http.auth.AdminAuth} calls this itself and DEGRADES
