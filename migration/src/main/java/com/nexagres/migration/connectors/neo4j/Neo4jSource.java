 ...
 * every other connector's live change feed does -- {@link com.nexagres.migration.coordinator.Coordinator#run}
...
public final class Neo4jSource implements Source {
     ...
     * a source with no live tail to follow, not a bug: {@link com.nexagres.migration.coordinator.Coordinator#run}
