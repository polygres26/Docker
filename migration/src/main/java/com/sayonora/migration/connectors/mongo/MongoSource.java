package com.sayonora.migration.connectors.mongo;
 ...
 * com.sayonora.migration.sink.WarpGrpcSink}'s underlying {@code RouterStage} would route them
 ...
 * {@link com.sayonora.migration.coordinator.Coordinator} once, before any partition is read, not
...
public final class MongoSource implements Source {
    ...
    /** {@link com.sayonora.migration.checkpoint.CdcCheckpointStore#save} casts its value with
