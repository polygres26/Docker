package com.sayonora.dms.sizing;
 ...
 * posture as {@link com.sayonora.dms.score.MigrationScorer}). A missing signal degrades to a
 ...
 * com.sayonora.dms.score.MigrationScorer}'s javadoc gives for its own weights.
 */
