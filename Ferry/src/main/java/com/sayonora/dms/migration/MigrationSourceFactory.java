...
import com.sayonora.migration.connectors.dynamo.DynamoSource;
import com.sayonora.migration.connectors.influx.InfluxSource;
import com.sayonora.migration.connectors.mongo.MongoSource;
import com.sayonora.migration.connectors.mssql.SqlServerSource;
import com.sayonora.migration.connectors.mysql.MySqlSource;
import com.sayonora.migration.connectors.neo4j.Neo4jSource;
import com.sayonora.migration.connectors.oracle.OracleSource;
import com.sayonora.migration.connectors.sqs.SqsSource;
 ...
 * integration test in {@code sayonora-migration} does (same client builders, same constructor
 ...
 * integration test in {@code sayonora-migration} already follows (see e.g. {@code
