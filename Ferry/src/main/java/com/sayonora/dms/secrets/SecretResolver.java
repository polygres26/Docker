 ...
 * Warp's own {@code com.sayonora.wire.secrets.SecretResolver} (same behavior: opt-in via env
...
public final class SecretResolver {
     ...
     * sayonora-migration} DynamoDB/SQS connector already makes. {@code region} on the ref
