...
export type StoreId = 'influxdb' | 'mongodb' | 'sqs' | 'neo4j' | 'opensearch' | 'dynamodb' | 's3' | 'redis' | 'azblob' | 'azqueue' | 'aztable' | 'gcs' | 'bigtable' | 'firestore' | 'datastore' | 'pubsub' | 'sns' | 'kinesis' | 'awsparams' | 'cql' | 'kafka' | 'gremlin'
