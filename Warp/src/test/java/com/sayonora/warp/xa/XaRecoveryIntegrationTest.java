...
class XaRecoveryIntegrationTest {
    ...
    void inDoubtBranchLeftByASimulatedCrashIsCommittedByStartupRecovery() throws Exception {
        try (RealPostgres controlPlane = RealPostgres.start();
            ...
            com.sayonora.warp.core.BackendTarget target = new com.sayonora.warp.core.BackendTarget(
                    "recoveryBackend", backend.jdbcUrl(), backend.username(), backend.password());
            com.sayonora.warp.core.BackendRegistry registry = com.sayonora.warp.core.BackendRegistry.fromConfig(
    ...
    private static com.sayonora.warp.server.ServerOptions controlPlaneOptions(RealPostgres controlPlane) {
        return com.sayonora.warp.server.ServerOptions.forTesting(
