...
class XaRecoveryIntegrationTest {
    ...
    void inDoubtBranchLeftByASimulatedCrashIsCommittedByStartupRecovery() throws Exception {
        try (RealPostgres controlPlane = RealPostgres.start();
            ...
            com.sayonora.wire.core.BackendTarget target = new com.sayonora.wire.core.BackendTarget(
                    "recoveryBackend", backend.jdbcUrl(), backend.username(), backend.password());
            com.sayonora.wire.core.BackendRegistry registry = com.sayonora.wire.core.BackendRegistry.fromConfig(
    ...
    private static com.sayonora.wire.server.ServerOptions controlPlaneOptions(RealPostgres controlPlane) {
        return com.sayonora.wire.server.ServerOptions.forTesting(
