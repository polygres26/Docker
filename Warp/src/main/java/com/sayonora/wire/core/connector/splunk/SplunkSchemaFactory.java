 ...
 * by {@link com.sayonora.wire.core.connector.ConnectorOperands}, see its javadoc for the text
 * grammar):
 * <pre>{@code
...
public final class SplunkSchemaFactory implements SchemaFactory {
    ...
    public static SplunkSchema createSchema(Map<String, Object> operand) {
        ...
        String authHeader = com.sayonora.wire.secrets.SecretResolver.resolve(stringOperandOrNull(operand, "authHeader"));
