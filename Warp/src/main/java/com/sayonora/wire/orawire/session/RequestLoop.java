...
import com.sayonora.wire.orawire.translator.BindVariableRewriter;
import com.sayonora.wire.xa.XaTransaction;
import com.sayonora.wire.orawire.translator.DualTableRewriter;
import com.sayonora.wire.orawire.ttc.BindParam;
import com.sayonora.wire.orawire.ttc.ColumnMetadata;
...
public final class RequestLoop {
    ...
    private final com.sayonora.wire.core.LazyPooledConnection pgConnection;
    private final com.sayonora.wire.core.LazyPooledConnection oracleConnection;
    ...
    private com.sayonora.wire.orawire.backend.NativeOracleExecutor nativeExecutor;
    ...
    public RequestLoop(TnsPacketReader reader, OutputStream out, com.sayonora.wire.core.LazyPooledConnection pgConnection,
            com.sayonora.wire.core.LazyPooledConnection oracleConnection, List<Connection> replicaConnections,
        ...
        this(reader, out, pgConnection, oracleConnection, replicaConnections, xaTransaction, options, sharedStages,
                backendRegistry, null, null, com.sayonora.wire.core.AccessContext.ANONYMOUS);
    }
    ...
    public RequestLoop(TnsPacketReader reader, OutputStream out, com.sayonora.wire.core.LazyPooledConnection pgConnection,
        ...
        this(reader, out, pgConnection, oracleConnection, replicaConnections, xaTransaction, options, sharedStages,
                backendRegistry, oracleUsername, oraclePassword, com.sayonora.wire.core.AccessContext.ANONYMOUS);
    }
    ...
    public RequestLoop(TnsPacketReader reader, OutputStream out, com.sayonora.wire.core.LazyPooledConnection pgConnection,
            ...
            XaTransaction xaTransaction,
            ServerOptions options, List<PipelineStage> sharedStages, com.sayonora.wire.core.BackendRegistry backendRegistry,
            String oracleUsername, String oraclePassword, com.sayonora.wire.core.AccessContext accessContext) {
    ...
    private void handleExecuteNative(ExecuteRequest request, TtcWriter w) throws SQLException {
        ...
        com.sayonora.wire.orawire.backend.NativeOracleExecutor.NativeQueryResult result =
