...
public final class OpenSearchWireServer {
    ...
    private void recordMetric(String operation, boolean write, String index, long startNanos) {
        if (sqlMetrics != null) {
            ...
            var kind = write ? com.sayonora.wire.core.SqlMetricsCollector.StatementKind.WRITE : com.sayonora.wire.core.SqlMetricsCollector.StatementKind.READ;
            sqlMetrics.recordOperation("oswire", index == null ? "default" : index, kind, operation, elapsedNanos, elapsedNanos);
            sqlMetrics.recordRttOutcome("oswire", write ? com.sayonora.wire.core.SqlMetricsCollector.OUTCOME_PG_WRITE
                    : com.sayonora.wire.core.SqlMetricsCollector.OUTCOME_PG_READ, elapsedNanos);
        }
    }
