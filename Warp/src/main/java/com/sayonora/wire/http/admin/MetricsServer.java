...
import com.sayonora.wire.config.FirewallRuleStore;
 ...
 * {@link com.sayonora.wire.http.auth.AccessContextResolver}, works against Okta, Entra ID, or any
 ...
 * else carries forward from the current version untouched. When a {@link com.sayonora.wire.core.BackendRegistry}
 ...
 * expose {@link com.sayonora.wire.core.DataExplorer}'s object browser and ad-hoc query console --
 ...
 * pure connectivity check) via {@link com.sayonora.wire.core.BackendConnectivityTest}; {@code
...
public final class MetricsServer {
    ...
    private final com.sayonora.wire.sqswire.PgQueueStore queueStore;
    ...
    private com.sayonora.wire.core.SqlPlanStore federationPlanStore;
    ...
    // another parameter.
    private com.sayonora.wire.core.QueryRepairStage queryRepairStage;

    public void setQueryRepairStage(com.sayonora.wire.core.QueryRepairStage queryRepairStage) {
    ...
    private com.sayonora.wire.core.AnomalyDetectionScheduler anomalyScheduler;

    public void setAnomalyScheduler(com.sayonora.wire.core.AnomalyDetectionScheduler anomalyScheduler) {
    ...
    public MetricsServer(int port, StatsCollectorStage statsStage, QosControlStage qosStage) {
        this(port, statsStage, qosStage, null, com.sayonora.wire.acl.ConnectionGate.DISABLED);
    }

    public MetricsServer(int port, StatsCollectorStage statsStage, QosControlStage qosStage,
            Supplier<ConfigStore.Version> currentVersionSupplier) {
        this(port, statsStage, qosStage, currentVersionSupplier, com.sayonora.wire.acl.ConnectionGate.DISABLED);
    }

    public MetricsServer(int port, StatsCollectorStage statsStage, QosControlStage qosStage,
            Supplier<ConfigStore.Version> currentVersionSupplier, com.sayonora.wire.acl.ConnectionGate connectionGate) {
    ...
    public MetricsServer(int port, StatsCollectorStage statsStage, QosControlStage qosStage,
            Supplier<ConfigStore.Version> currentVersionSupplier, com.sayonora.wire.acl.ConnectionGate connectionGate,
            com.sayonora.wire.http.auth.AccessContextResolver oauth, FirewallRuleStore firewallRuleStore) {
    ...
    public MetricsServer(int port, StatsCollectorStage statsStage, QosControlStage qosStage,
            Supplier<ConfigStore.Version> currentVersionSupplier, com.sayonora.wire.acl.ConnectionGate connectionGate,
            com.sayonora.wire.http.auth.AccessContextResolver oauth, FirewallRuleStore firewallRuleStore,
            ConfigStore configStore, com.sayonora.wire.core.BackendRegistry backendRegistry) {
        this(port, statsStage, qosStage, currentVersionSupplier, connectionGate, oauth, firewallRuleStore,
    ...
    public MetricsServer(int port, StatsCollectorStage statsStage, QosControlStage qosStage,
            ...
            com.sayonora.wire.http.auth.AccessContextResolver oauth, FirewallRuleStore firewallRuleStore,
            ConfigStore configStore, com.sayonora.wire.core.BackendRegistry backendRegistry,
            com.sayonora.wire.core.DialectTranslationStage dialectTranslationStage, String adminWebDir) {
        this(port, statsStage, qosStage, currentVersionSupplier, connectionGate, oauth, firewallRuleStore,
     ...
     * {@code GET /api/nodes} (deployment-topology visibility, see {@link com.sayonora.wire.config.NodeRegistry}).
     */
    public MetricsServer(int port, StatsCollectorStage statsStage, QosControlStage qosStage,
            Supplier<ConfigStore.Version> currentVersionSupplier, com.sayonora.wire.acl.ConnectionGate connectionGate,
            com.sayonora.wire.http.auth.AccessContextResolver oauth, FirewallRuleStore firewallRuleStore,
            ConfigStore configStore, com.sayonora.wire.core.BackendRegistry backendRegistry,
            com.sayonora.wire.core.DialectTranslationStage dialectTranslationStage, String adminWebDir,
            com.sayonora.wire.server.ServerOptions options) {
        this(port, statsStage, qosStage, currentVersionSupplier, connectionGate, oauth, firewallRuleStore,
     ...
     * {@link com.sayonora.wire.mcp.McpMetricsCollector} instance {@code Main} also passes to
    ...
    public MetricsServer(int port, StatsCollectorStage statsStage, QosControlStage qosStage,
            ...
            ConfigStore configStore, com.sayonora.wire.core.BackendRegistry backendRegistry,
            com.sayonora.wire.core.DialectTranslationStage dialectTranslationStage, String adminWebDir,
            com.sayonora.wire.server.ServerOptions options, com.sayonora.wire.mcp.McpMetricsCollector mcpMetrics) {
        this(port, statsStage, qosStage, currentVersionSupplier, connectionGate, oauth, firewallRuleStore,
     ...
     * {@code GET /api/capture} (this instance's in-memory {@link com.sayonora.wire.capture.WorkloadCaptureBuffer},
    ...
    public MetricsServer(int port, StatsCollectorStage statsStage, QosControlStage qosStage,
            ...
            com.sayonora.wire.core.DialectTranslationStage dialectTranslationStage, String adminWebDir,
            com.sayonora.wire.server.ServerOptions options, com.sayonora.wire.mcp.McpMetricsCollector mcpMetrics,
            com.sayonora.wire.capture.WorkloadCaptureBuffer captureBuffer) {
        this(port, statsStage, qosStage, currentVersionSupplier, connectionGate, oauth, firewallRuleStore,
     ...
     * {@code GET /api/audit} (this process's recent {@link com.sayonora.wire.audit.AuditEvent}s,
     ...
     * {@code GET /api/federation/plans}: every {@link com.sayonora.wire.core.ShardJoinExecutor}/
     * {@link com.sayonora.wire.core.SchemaFederationStage} federated query's real captured
    ...
    public MetricsServer(int port, StatsCollectorStage statsStage, QosControlStage qosStage,
            ...
            com.sayonora.wire.server.ServerOptions options, com.sayonora.wire.mcp.McpMetricsCollector mcpMetrics,
            com.sayonora.wire.capture.WorkloadCaptureBuffer captureBuffer,
            com.sayonora.wire.audit.AuditLog auditLog, com.sayonora.wire.xa.XaRecoveryLog xaRecoveryLog,
     ...
     * in-doubt XA branch against it (see {@link com.sayonora.wire.xa.XaRecoveryLog#hasUnresolvedFor}'s
     * javadoc for why), and the drain/undrain routes fan out to every other live node in {@code
     * warp_nodes} (see {@link com.sayonora.wire.config.NodeRegistry}) instead of only mutating
    ...
    public MetricsServer(int port, StatsCollectorStage statsStage, QosControlStage qosStage,
        ...
        this.queueStore = backendRegistry == null ? null : new com.sayonora.wire.sqswire.PgQueueStore(backendRegistry);
        ...
        AbstractHandler api = new AbstractHandler() {
            ...
            public void handle(String target, Request baseRequest, HttpServletRequest request,
                ...
                if (federationPlanStore != null && "/api/federation/plans".equals(target)) {
                    ...
                    boolean first = true;
                    for (com.sayonora.wire.core.SqlPlanStore.PlanEntry entry : federationPlanStore.snapshot()) {
                        ...
                        for (com.sayonora.wire.core.SqlPlanStore.LeafScanMetric leaf : entry.leafScans()) {
     ...
     * by {@link com.sayonora.wire.http.auth.AccessContextResolver} against Okta, Entra ID, or any
    ...
    static void recordAdminAction(com.sayonora.wire.audit.AuditLog auditLog, AccessContext accessContext,
        ...
        auditLog.record(com.sayonora.wire.audit.AuditEvent.of(
                com.sayonora.wire.audit.AuditEvent.Type.ADMIN_ACTION, userId, httpMethod + " " + target));
    }
    ...
    private static void handleFirewallRules(String target, HttpServletRequest request, HttpServletResponse response,
            FirewallRuleStore store, com.sayonora.wire.core.DialectTranslationStage dialectTranslationStage) throws java.io.IOException {
        response.setContentType("application/json; charset=utf-8");
        try {
    ...
    private static void handleFirewallRuleDraft(HttpServletRequest request, HttpServletResponse response,
            com.sayonora.wire.core.DialectTranslationStage dialectTranslationStage) throws java.io.IOException {
        com.sayonora.wire.core.TranslationLlmClient llmClient =
    ...
    private static void handleQosSuggestionDraft(HttpServletResponse response, ConfigStore configStore,
            StatsCollectorStage statsStage, com.sayonora.wire.core.DialectTranslationStage dialectTranslationStage)
        ...
        if ("default".equalsIgnoreCase(target)) {
            ...
            var classLimits = new java.util.LinkedHashMap<>(com.sayonora.wire.core.QosControlStage.parseClassLimitsSpec(
                    current.qosClassLimits(), maxWaitMillis));
            classLimits.put(target, new com.sayonora.wire.core.QosControlStage.ClassLimit(ratePerSecond, burstCapacity, maxWaitMillis));
            responseBody.addProperty("qosClassLimitsIfApplied",
                    com.sayonora.wire.core.QosControlStage.formatClassLimitsSpec(classLimits));
        }
        responseBody.addProperty("applied", false);
    ...
    private static void handleRollupSuggestionDraft(HttpServletResponse response, ConfigStore configStore,
        ...
        WarpConfig current;
        java.util.List<com.sayonora.wire.rollup.RollupDefinition> existingRollups;
        try {
            current = configStore.readLatest().map(ConfigStore.Version::payload).orElseGet(WarpConfig::fromEnvDefaults);
            existingRollups = com.sayonora.wire.rollup.RollupConfig.parse(current.rollupDefinitionsYaml());
        } catch (java.sql.SQLException e) {
        ...
        try {
            ...
            String candidateSingleYaml = com.sayonora.wire.rollup.RollupConfig.toYaml(java.util.List.of(
                    new com.sayonora.wire.rollup.RollupDefinition(name, backend, sourceTable,
                            groupBy, aggregations, refreshMinutes, stalenessMinutes)));
            java.util.List<com.sayonora.wire.rollup.RollupDefinition> parsedNew =
                    com.sayonora.wire.rollup.RollupConfig.parse(candidateSingleYaml);
            var candidateList = new java.util.ArrayList<>(existingRollups);
            candidateList.addAll(parsedNew);
            candidateYaml = com.sayonora.wire.rollup.RollupConfig.toYaml(candidateList);
        } catch (RuntimeException e) {
    ...
    private static void handleRouterSuggestionDraft(HttpServletResponse response, ConfigStore configStore,
            StatsCollectorStage statsStage, com.sayonora.wire.core.DialectTranslationStage dialectTranslationStage,
            com.sayonora.wire.core.BackendRegistry backendRegistry) throws java.io.IOException {
        response.setContentType("application/json; charset=utf-8");
        com.sayonora.wire.core.TranslationLlmClient llmClient =
                dialectTranslationStage == null ? null : dialectTranslationStage.llmClient();
        if (llmClient == null) {
        ...
        int actualCount = com.sayonora.wire.core.RouterStage.fromConfig(null, null, null, null, candidateSpec, backendRegistry)
    ...
    private static void handleLlmConfig(HttpServletRequest request, HttpServletResponse response,
            ConfigStore configStore, com.sayonora.wire.core.DialectTranslationStage dialectTranslationStage)
            throws java.io.IOException {
        response.setContentType("application/json; charset=utf-8");
        try {
            if ("GET".equals(request.getMethod())) {
    ...
    private static void handleBackends(String target, HttpServletRequest request, HttpServletResponse response,
            com.sayonora.wire.core.BackendRegistry backendRegistry, com.sayonora.wire.xa.XaRecoveryLog xaRecoveryLog,
            com.sayonora.wire.server.ServerOptions options, int selfAdminPort, String forwardedAuthHeader)
            throws java.io.IOException {
        response.setContentType("application/json; charset=utf-8");
        try {
            ...
            if ("/api/backends/test".equals(target) && "POST".equals(request.getMethod())) {
                ...
                var result = com.sayonora.wire.core.BackendConnectivityTest.test(
                ...
                com.sayonora.wire.core.BackendTarget t = requireBackend(backendRegistry, testNamedMatch.group(1), response);
                if (t == null) return;
                var result = com.sayonora.wire.core.BackendConnectivityTest.test(t.jdbcUrl(), t.user(), t.password());
                response.setStatus(HttpServletResponse.SC_OK);
                response.getWriter().write("{\"ok\":" + result.ok()
                        + ",\"message\":" + jsonString(result.message())
                        + ",\"tookMs\":" + result.tookMs()
                ...
                StringBuilder json = new StringBuilder("[");
                boolean first = true;
                for (com.sayonora.wire.core.BackendTarget t : backendRegistry.all()) {
                    if (!first) json.append(',');
                    first = false;
                ...
                com.sayonora.wire.core.BackendTarget t = requireBackend(backendRegistry, drainMatch.group(1), response);
                if (t == null) return;
                ...
                backendRegistry.setState(t.name(), com.sayonora.wire.core.BackendRegistry.BackendState.DRAINING);
                var result = com.sayonora.wire.core.BackendConnectionPools.drain(t.poolKey(), graceMs);
                ...
                if (!local && t.fallbackName() != null) {
                    com.sayonora.wire.core.BackendTarget fallback = backendRegistry.get(t.fallbackName());
                    if (fallback != null) {
                        var lag = com.sayonora.wire.core.ReplicationLag.awaitLagBelow(fallback, 0.0, graceMs);
                ...
                com.sayonora.wire.core.BackendTarget t = requireBackend(backendRegistry, undrainMatch.group(1), response);
                if (t == null) return;
                boolean local = "true".equals(request.getParameter("local"));
                backendRegistry.setState(t.name(), com.sayonora.wire.core.BackendRegistry.BackendState.ACTIVE);
                java.util.List<String> peerResults = local ? java.util.List.of()
                        : fanOutToPeers(options, selfAdminPort, forwardedAuthHeader,
                ...
                com.sayonora.wire.core.BackendTarget t = requireBackend(backendRegistry, tablesMatch.group(1), response);
                if (t == null) return;
                StringBuilder json = new StringBuilder("[");
                boolean first = true;
                for (var table : com.sayonora.wire.core.DataExplorer.listTables(t)) {
                    if (!first) json.append(',');
                    first = false;
                ...
                com.sayonora.wire.core.BackendTarget t = requireBackend(backendRegistry, columnsMatch.group(1), response);
                if (t == null) return;
                StringBuilder json = new StringBuilder("[");
                boolean first = true;
                for (var col : com.sayonora.wire.core.DataExplorer.listColumns(t, columnsMatch.group(2), columnsMatch.group(3))) {
                    if (!first) json.append(',');
                    first = false;
                ...
                com.sayonora.wire.core.BackendTarget t = requireBackend(backendRegistry, queryMatch.group(1), response);
                if (t == null) return;
                JsonObject body = readJsonBody(request);
                if (!body.has("sql") || body.get("sql").getAsString().isBlank()) {
                    throw new IllegalArgumentException("sql is required");
                }
                var result = com.sayonora.wire.core.DataExplorer.runQuery(t, body.get("sql").getAsString());
    ...
    private static com.sayonora.wire.core.BackendTarget requireBackend(com.sayonora.wire.core.BackendRegistry backendRegistry,
            String name, HttpServletResponse response) throws java.io.IOException {
        com.sayonora.wire.core.BackendTarget t = backendRegistry.get(name);
        if (t == null) {
            response.setStatus(HttpServletResponse.SC_NOT_FOUND);
     ...
     * {@link com.sayonora.wire.config.NodeRegistry#listAll} (the same table the {@code /api/nodes}
     ...
     */
    private static java.util.List<String> fanOutToPeers(com.sayonora.wire.server.ServerOptions options,
            int selfAdminPort, String authHeader, String path) {
        java.util.List<String> results = new java.util.ArrayList<>();
        if (options == null) {
            return results;
        }
        java.util.List<com.sayonora.wire.config.NodeRegistry.NodeRow> nodes;
        try {
            nodes = com.sayonora.wire.config.NodeRegistry.listAll(options);
        } catch (java.sql.SQLException e) {
            results.add("ERROR: could not list cluster nodes to fan out to: " + e.getMessage());
            return results;
        }
        String selfHost = com.sayonora.wire.config.NodeRegistry.resolveHost();
     ...
     * its live depth (visible/in-flight message counts from {@link com.sayonora.wire.sqswire.PgQueueStore#countMessages}),
    ...
    private static void handleQueues(String target, HttpServletRequest request, HttpServletResponse response,
            com.sayonora.wire.sqswire.PgQueueStore queueStore) throws java.io.IOException {
        response.setContentType("application/json; charset=utf-8");
        try {
     ...
     * {@link com.sayonora.wire.capture.WorkloadCaptureBuffer}, oldest-first, {@code localSeq}
     ...
     * the fleet -- see {@link com.sayonora.wire.capture.WorkloadCaptureBuffer}'s javadoc.
     */
    private static void handleCapture(HttpServletRequest request, HttpServletResponse response,
            com.sayonora.wire.capture.WorkloadCaptureBuffer captureBuffer) throws java.io.IOException {
        response.setContentType("application/json; charset=utf-8");
        if (!"GET".equals(request.getMethod())) {
            response.setStatus(HttpServletResponse.SC_NOT_FOUND);
            response.getWriter().write("{\"error\":\"no such route\"}");
        ...
        StringBuilder json = new StringBuilder("[");
        boolean first = true;
        for (com.sayonora.wire.capture.WorkloadCaptureBuffer.Entry e : captureBuffer.since(since, limit)) {
            if (!first) json.append(',');
            first = false;
     ...
     * buffer otherwise (see {@link com.sayonora.wire.audit.AuditLog#recent}). */
    private static void handleAudit(HttpServletRequest request, HttpServletResponse response,
            com.sayonora.wire.audit.AuditLog auditLog) throws java.io.IOException {
        response.setContentType("application/json; charset=utf-8");
        if (!"GET".equals(request.getMethod())) {
            response.setStatus(HttpServletResponse.SC_NOT_FOUND);
            response.getWriter().write("{\"error\":\"no such route\"}");
        ...
        StringBuilder json = new StringBuilder("[");
        boolean first = true;
        for (com.sayonora.wire.audit.AuditEvent event : auditLog.recent(limit)) {
            if (!first) json.append(',');
            first = false;
            json.append(com.sayonora.wire.audit.AuditLog.toJson(event));
        }
        json.append(']');
        response.setStatus(HttpServletResponse.SC_OK);
        response.getWriter().write(json.toString());
     ...
     * {@link com.sayonora.wire.audit.AuditLog#recent}, which returns EVERY event type most-recent-
    ...
    private static void handleMcpAuditSummarize(HttpServletRequest request, HttpServletResponse response,
            com.sayonora.wire.audit.AuditLog auditLog, com.sayonora.wire.core.DialectTranslationStage dialectTranslationStage)
            throws java.io.IOException {
        response.setContentType("application/json; charset=utf-8");
        com.sayonora.wire.core.TranslationLlmClient llmClient =
                dialectTranslationStage == null ? null : dialectTranslationStage.llmClient();
        ...
        java.util.List<com.sayonora.wire.audit.AuditEvent> matched = new java.util.ArrayList<>();
        for (com.sayonora.wire.audit.AuditEvent event : auditLog.recent(Math.min(limit * 10, 2000))) {
            if (event.type() != com.sayonora.wire.audit.AuditEvent.Type.MCP_TOOL_CALLED) {
                continue;
            }
        ...
        StringBuilder context = new StringBuilder();
        for (com.sayonora.wire.audit.AuditEvent event : matched) {
     ...
     * {@code warp_nodes} (see {@link com.sayonora.wire.config.NodeRegistry}). Sorted by zone
    ...
    private static void handleNodes(HttpServletRequest request, HttpServletResponse response,
            com.sayonora.wire.server.ServerOptions options) throws java.io.IOException {
        response.setContentType("application/json; charset=utf-8");
        if (!"GET".equals(request.getMethod())) {
            response.setStatus(HttpServletResponse.SC_NOT_FOUND);
            response.getWriter().write("{\"error\":\"no such route\"}");
        ...
        try {
            StringBuilder json = new StringBuilder("[");
            boolean first = true;
            for (com.sayonora.wire.config.NodeRegistry.NodeRow row : com.sayonora.wire.config.NodeRegistry.listAll(options)) {
                if (!first) json.append(',');
                first = false;
    ...
    private static String renderAnomalies(com.sayonora.wire.core.AnomalyDetectionScheduler anomalyScheduler) {
    ...
    private static String renderMetricsSummary(StatsCollectorStage statsStage,
            com.sayonora.wire.mcp.McpMetricsCollector mcpMetrics,
            com.sayonora.wire.core.QueryRepairStage queryRepairStage) {
        com.sayonora.wire.core.SqlMetricsCollector.Snapshot snap = statsStage.sqlMetricsSnapshot();
        StringBuilder json = new StringBuilder("{");
