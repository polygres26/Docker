package com.sayonora.warp.license;

/**
 * The two commercial tiers Warp ships under -- see {@link License}'s class doc for the full
...
public enum LicenseTier {
     ...
     * warp_nodes} -- see {@code NodeRegistry#countLive}), {@link
    ...
    /** Unlocked by a valid, unexpired {@code WARP_LICENSE_KEY} -- see {@link
