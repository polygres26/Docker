...
public final class MongoWireSessionHandler implements Runnable {
    ...
    public MongoWireSessionHandler(Socket clientSocket, String pgUrl, String pgUser, String pgPassword, com.sayonora.warp.cluster.RowCache cache) {
        this(clientSocket, pgUrl, pgUser, pgPassword, cache, null);
    }

    public MongoWireSessionHandler(Socket clientSocket, String pgUrl, String pgUser, String pgPassword,
            com.sayonora.warp.cluster.RowCache cache, com.sayonora.warp.core.SqlMetricsCollector sqlMetrics) {
     ...
     */
    public MongoWireSessionHandler(Socket clientSocket, com.sayonora.warp.core.BackendRegistry backendRegistry,
            com.sayonora.warp.cluster.RowCache cache, com.sayonora.warp.core.SqlMetricsCollector sqlMetrics) {
        this.clientSocket = clientSocket;
