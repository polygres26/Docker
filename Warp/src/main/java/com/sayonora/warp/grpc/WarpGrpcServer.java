...
public final class WarpGrpcServer {
    ...
    private final com.sayonora.warp.acl.ConnectionGate connectionGate;
    ...
    public WarpGrpcServer(ServerOptions options, List<PipelineStage> sharedStages,
        ...
        this(options, sharedStages, backendRegistry, com.sayonora.warp.acl.ConnectionGate.DISABLED);
    }
