...
import com.sayonora.warp.config.FirewallRuleStore;
 ...
 * {@link com.sayonora.warp.http.auth.AccessContextResolver}, works against Okta, Entra ID, or any
 ...
 * else carries forward from the current version untouched. When a {@link com.sayonora.warp.core.BackendRegistry}
 ...
 * expose {@link com.sayonora.warp.core.DataExplorer}'s object browser and ad-hoc query console --
...
public final class MetricsServer {
    ...
    private com.sayonora.warp.core.SqlPlanStore federationPlanStore;
    ...
    public MetricsServer(int port, StatsCollectorStage statsStage, QosControlStage qosStage,
        ...
        this(port, statsStage, qosStage, currentVersionSupplier, com.sayonora.warp.acl.ConnectionGate.DISABLED);
    }

    public MetricsServer(int port, StatsCollectorStage statsStage, QosControlStage qosStage,
            Supplier<ConfigStore.Version> currentVersionSupplier, com.sayonora.warp.acl.ConnectionGate connectionGate) {
        this(port, statsStage, qosStage, currentVersionSupplier, connectionGate,
                com.sayonora.warp.http.auth.AccessContextResolver.DISABLED);
    }
    ...
    public MetricsServer(int port, StatsCollectorStage statsStage, QosControlStage qosStage,
            Supplier<ConfigStore.Version> currentVersionSupplier, com.sayonora.warp.acl.ConnectionGate connectionGate,
            com.sayonora.warp.http.auth.AccessContextResolver oauth, FirewallRuleStore firewallRuleStore) {
    ...
    public MetricsServer(int port, StatsCollectorStage statsStage, QosControlStage qosStage,
            Supplier<ConfigStore.Version> currentVersionSupplier, com.sayonora.warp.acl.ConnectionGate connectionGate,
            com.sayonora.warp.http.auth.AccessContextResolver oauth, FirewallRuleStore firewallRuleStore,
            ConfigStore configStore, com.sayonora.warp.core.BackendRegistry backendRegistry) {
        this(port, statsStage, qosStage, currentVersionSupplier, connectionGate, oauth, firewallRuleStore,
     ...
     * built {@code Warp/web} SPA's {@code dist/} directory. When set, static assets are served by
    ...
    public MetricsServer(int port, StatsCollectorStage statsStage, QosControlStage qosStage,
            ...
            com.sayonora.warp.http.auth.AccessContextResolver oauth, FirewallRuleStore firewallRuleStore,
            ConfigStore configStore, com.sayonora.warp.core.BackendRegistry backendRegistry,
            com.sayonora.warp.core.DialectTranslationStage dialectTranslationStage, String adminWebDir) {
        this(port, statsStage, qosStage, currentVersionSupplier, connectionGate, oauth, firewallRuleStore,
     ...
     * {@code GET /api/nodes} (deployment-topology visibility, see {@link com.sayonora.warp.config.NodeRegistry}).
     */
    public MetricsServer(int port, StatsCollectorStage statsStage, QosControlStage qosStage,
            Supplier<ConfigStore.Version> currentVersionSupplier, com.sayonora.warp.acl.ConnectionGate connectionGate,
            com.sayonora.warp.http.auth.AccessContextResolver oauth, FirewallRuleStore firewallRuleStore,
            ConfigStore configStore, com.sayonora.warp.core.BackendRegistry backendRegistry,
            com.sayonora.warp.core.DialectTranslationStage dialectTranslationStage, String adminWebDir,
            com.sayonora.warp.server.ServerOptions options) {
        this(port, statsStage, qosStage, currentVersionSupplier, connectionGate, oauth, firewallRuleStore,
     ...
     * {@link com.sayonora.warp.mcp.McpMetricsCollector} instance {@code Main} also passes to
    ...
    public MetricsServer(int port, StatsCollectorStage statsStage, QosControlStage qosStage,
            ...
            ConfigStore configStore, com.sayonora.warp.core.BackendRegistry backendRegistry,
            com.sayonora.warp.core.DialectTranslationStage dialectTranslationStage, String adminWebDir,
            com.sayonora.warp.server.ServerOptions options, com.sayonora.warp.mcp.McpMetricsCollector mcpMetrics) {
        this(port, statsStage, qosStage, currentVersionSupplier, connectionGate, oauth, firewallRuleStore,
     ...
     * {@code GET /api/capture} (this instance's in-memory {@link com.sayonora.warp.capture.WorkloadCaptureBuffer},
    ...
    public MetricsServer(int port, StatsCollectorStage statsStage, QosControlStage qosStage,
            ...
            com.sayonora.warp.core.DialectTranslationStage dialectTranslationStage, String adminWebDir,
            com.sayonora.warp.server.ServerOptions options, com.sayonora.warp.mcp.McpMetricsCollector mcpMetrics,
            com.sayonora.warp.capture.WorkloadCaptureBuffer captureBuffer) {
        this(port, statsStage, qosStage, currentVersionSupplier, connectionGate, oauth, firewallRuleStore,
     ...
     * {@code GET /api/audit} (this process's recent {@link com.sayonora.warp.audit.AuditEvent}s,
     ...
     * {@code GET /api/federation/plans}: every {@link com.sayonora.warp.core.ShardJoinExecutor}/
     * {@link com.sayonora.warp.core.SchemaFederationStage} federated query's real captured
    ...
    public MetricsServer(int port, StatsCollectorStage statsStage, QosControlStage qosStage,
            ...
            com.sayonora.warp.server.ServerOptions options, com.sayonora.warp.mcp.McpMetricsCollector mcpMetrics,
            com.sayonora.warp.capture.WorkloadCaptureBuffer captureBuffer,
            com.sayonora.warp.audit.AuditLog auditLog, com.sayonora.warp.xa.XaRecoveryLog xaRecoveryLog,
     ...
     * in-doubt XA branch against it (see {@link com.sayonora.warp.xa.XaRecoveryLog#hasUnresolvedFor}'s
     * javadoc for why), and the drain/undrain routes fan out to every other live node in {@code
     * warp_nodes} (see {@link com.sayonora.warp.config.NodeRegistry}) instead of only mutating
        ...
        AbstractHandler api = new AbstractHandler() {
            ...
            public void handle(String target, Request baseRequest, HttpServletRequest request,
                ...
                if (federationPlanStore != null && "/api/federation/plans".equals(target)) {
                    ...
                    boolean first = true;
                    for (com.sayonora.warp.core.SqlPlanStore.PlanEntry entry : federationPlanStore.snapshot()) {
                        ...
                        for (com.sayonora.warp.core.SqlPlanStore.LeafScanMetric leaf : entry.leafScans()) {
                ...
                if (com.sayonora.warp.ab.AbRoutingApi.handles(target)) {
                    ...
                    com.sayonora.warp.ab.AbRoutingApi.handle(target, request, response,
                            accessContext.isAnonymous() ? "shared-admin-token" : accessContext.userId());
                    baseRequest.setHandled(true);
                    return;
                }
     ...
     * by {@link com.sayonora.warp.http.auth.AccessContextResolver} against Okta, Entra ID, or any
    ...
    static void recordAdminAction(com.sayonora.warp.audit.AuditLog auditLog, AccessContext accessContext,
        ...
        auditLog.record(com.sayonora.warp.audit.AuditEvent.of(
                com.sayonora.warp.audit.AuditEvent.Type.ADMIN_ACTION, userId, httpMethod + " " + target));
    }
    ...
    private static void handleFirewallRules(String target, HttpServletRequest request, HttpServletResponse response,
            FirewallRuleStore store, com.sayonora.warp.core.DialectTranslationStage dialectTranslationStage) throws java.io.IOException {
        response.setContentType("application/json; charset=utf-8");
        try {
    ...
    private static void handleFirewallRuleDraft(HttpServletRequest request, HttpServletResponse response,
            com.sayonora.warp.core.DialectTranslationStage dialectTranslationStage) throws java.io.IOException {
        com.sayonora.warp.core.TranslationLlmClient llmClient =
    ...
    private static void handleQosSuggestionDraft(HttpServletResponse response, ConfigStore configStore,
            StatsCollectorStage statsStage, com.sayonora.warp.core.DialectTranslationStage dialectTranslationStage)
        ...
        if ("default".equalsIgnoreCase(target)) {
            ...
            var classLimits = new java.util.LinkedHashMap<>(com.sayonora.warp.core.QosControlStage.parseClassLimitsSpec(
                    current.qosClassLimits(), maxWaitMillis));
            classLimits.put(target, new com.sayonora.warp.core.QosControlStage.ClassLimit(ratePerSecond, burstCapacity, maxWaitMillis));
            responseBody.addProperty("qosClassLimitsIfApplied",
                    com.sayonora.warp.core.QosControlStage.formatClassLimitsSpec(classLimits));
        }
        responseBody.addProperty("applied", false);
    ...
    private static void handleRollupSuggestionDraft(HttpServletResponse response, ConfigStore configStore,
        ...
        WarpConfig current;
        java.util.List<com.sayonora.warp.rollup.RollupDefinition> existingRollups;
        try {
            current = configStore.readLatest().map(ConfigStore.Version::payload).orElseGet(WarpConfig::fromEnvDefaults);
            existingRollups = com.sayonora.warp.rollup.RollupConfig.parse(current.rollupDefinitionsYaml());
        } catch (java.sql.SQLException e) {
        ...
        try {
            ...
            String candidateSingleYaml = com.sayonora.warp.rollup.RollupConfig.toYaml(java.util.List.of(
                    new com.sayonora.warp.rollup.RollupDefinition(name, backend, sourceTable,
                            groupBy, aggregations, refreshMinutes, stalenessMinutes)));
            java.util.List<com.sayonora.warp.rollup.RollupDefinition> parsedNew =
                    com.sayonora.warp.rollup.RollupConfig.parse(candidateSingleYaml);
            var candidateList = new java.util.ArrayList<>(existingRollups);
            candidateList.addAll(parsedNew);
            candidateYaml = com.sayonora.warp.rollup.RollupConfig.toYaml(candidateList);
        } catch (RuntimeException e) {
    ...
    private static void handleRouterSuggestionDraft(HttpServletResponse response, ConfigStore configStore,
            StatsCollectorStage statsStage, com.sayonora.warp.core.DialectTranslationStage dialectTranslationStage,
            com.sayonora.warp.core.BackendRegistry backendRegistry) throws java.io.IOException {
        response.setContentType("application/json; charset=utf-8");
        com.sayonora.warp.core.TranslationLlmClient llmClient =
                dialectTranslationStage == null ? null : dialectTranslationStage.llmClient();
        if (llmClient == null) {
        ...
        int actualCount = com.sayonora.warp.core.RouterStage.fromConfig(null, null, null, null, candidateSpec, backendRegistry)
        ...
        try {
            if ("GET".equals(request.getMethod())) {
                ...
                WarpConfig updated = new WarpConfig(
                        ...
                        field(body, "backendSets", current.backendSets()),
                ...
                // entirely, so a set naming one of those is intentionally not validatable here --
     ...
     * {@code apiKeySet: boolean}), mirroring Sayonora DMS's {@code LlmSettingsStore}/{@code
    ...
    private static void handleLlmConfig(HttpServletRequest request, HttpServletResponse response,
            ConfigStore configStore, com.sayonora.warp.core.DialectTranslationStage dialectTranslationStage)
            throws java.io.IOException {
        response.setContentType("application/json; charset=utf-8");
        try {
            if ("GET".equals(request.getMethod())) {
    ...
    private static String groupOrNull(com.sayonora.warp.core.BackendRegistry registry, String backendName) {
        var info = registry.groupInfoFor(backendName);
        return info == null || com.sayonora.warp.core.BackendRegistry.UNGROUPED_GROUP_NAME.equals(info.name())
                ? null : info.name();
    }
     ...
     * {@link com.sayonora.warp.mcp.McpEndpoints}). They persist as the {@code mcpEndpoints} field of
        ...
        try {
            synchronized (MCP_ENDPOINT_LOCK) {
                WarpConfig current = configStore.readLatest().map(ConfigStore.Version::payload)
                        .orElseGet(WarpConfig::fromEnvDefaults);
                java.util.List<com.sayonora.warp.mcp.McpEndpoints.Endpoint> all =
                        new java.util.ArrayList<>(com.sayonora.warp.mcp.McpEndpoints.parse(current.mcpEndpoints()));
                java.time.Instant now = clock.instant();
                if (id == null && "GET".equals(method)) {
                    com.google.gson.JsonArray arr = new com.google.gson.JsonArray();
                    all.forEach(e -> arr.add(com.sayonora.warp.mcp.McpEndpoints.view(e, now)));
                    response.setStatus(HttpServletResponse.SC_OK);
                ...
                if (id == null && "POST".equals(method)) {
                    ...
                    com.sayonora.warp.mcp.McpScope scope = com.sayonora.warp.mcp.McpScope.fromSpec(scopeSpec);
                    if (backendRegistry != null) {
                        if (scope.type() == com.sayonora.warp.mcp.McpScope.Type.DATABASE
                        ...
                        if (scope.type() == com.sayonora.warp.mcp.McpScope.Type.GROUP
                    ...
                    java.time.Instant expiresAt = com.sayonora.warp.mcp.McpEndpoints
                            .resolveExpiry(optionalString(body, "expiresAt"), ttl, clock).orElse(null);
                    String token = com.sayonora.warp.mcp.McpEndpoints.newToken();
                    com.sayonora.warp.mcp.McpEndpoints.Endpoint created = new com.sayonora.warp.mcp.McpEndpoints.Endpoint(
                ...
                if (id != null) {
                    ...
                    com.sayonora.warp.mcp.McpEndpoints.Endpoint e = all.get(idx);
                    if ("GET".equals(method)) {
                        response.setStatus(HttpServletResponse.SC_OK);
                        response.getWriter().write(com.sayonora.warp.mcp.McpEndpoints.view(e, now).toString());
                        return;
                    }
                    ...
                    if ("PATCH".equals(method) || "PUT".equals(method)) {
                        ...
                        if (body.has("expiresAt") && body.get("expiresAt").isJsonNull()
                            ...
                            Long ttl = body.has("ttlSeconds") && !body.get("ttlSeconds").isJsonNull()
                                    ? body.get("ttlSeconds").getAsLong() : null;
                            e = e.withExpiresAt(com.sayonora.warp.mcp.McpEndpoints
                                    .resolveExpiry(optionalString(body, "expiresAt"), ttl, clock).orElse(null));
                        }
    ...
    private static void handleBackends(String target, HttpServletRequest request, HttpServletResponse response,
            com.sayonora.warp.core.BackendRegistry backendRegistry, com.sayonora.warp.xa.XaRecoveryLog xaRecoveryLog,
            com.sayonora.warp.server.ServerOptions options, int selfAdminPort, String forwardedAuthHeader)
            throws java.io.IOException {
        response.setContentType("application/json; charset=utf-8");
        try {
            ...
            if ("/api/backends/test".equals(target) && "POST".equals(request.getMethod())) {
                ...
                var result = com.sayonora.warp.core.BackendConnectivityTest.test(
                ...
                com.sayonora.warp.core.BackendTarget t = requireBackend(backendRegistry, testNamedMatch.group(1), response);
                if (t == null) return;
                var result = com.sayonora.warp.core.BackendConnectivityTest.test(t.jdbcUrl(), t.user(), t.password());
                response.setStatus(HttpServletResponse.SC_OK);
                response.getWriter().write("{\"ok\":" + result.ok()
                        + ",\"message\":" + jsonString(result.message())
                        + ",\"tookMs\":" + result.tookMs()
                ...
                StringBuilder json = new StringBuilder("[");
                boolean first = true;
                for (com.sayonora.warp.core.BackendTarget t : backendRegistry.all()) {
                    if (!first) json.append(',');
                    first = false;
                    json.append("{\"name\":").append(jsonString(t.name()))
                            ...
                            .append(",\"type\":").append(jsonString(com.sayonora.warp.mcp.BackendTypes.typeOf(t)))
                            .append(",\"family\":").append(jsonString(com.sayonora.warp.mcp.BackendTypes.kindOf(t).id()))
                            ...
                            .append(",\"enabledStores\":").append(jsonStringArray(backendRegistry.enabledStores(t.name())
                                    .stream().map(com.sayonora.warp.core.StoreType::id).toList()))
                            .append('}');
                }
                json.append(']');
                response.setStatus(HttpServletResponse.SC_OK);
                ...
                com.sayonora.warp.core.BackendTarget t = requireBackend(backendRegistry, drainMatch.group(1), response);
                if (t == null) return;
                ...
                backendRegistry.setState(t.name(), com.sayonora.warp.core.BackendRegistry.BackendState.DRAINING);
                var result = com.sayonora.warp.core.BackendConnectionPools.drain(t.poolKey(), graceMs);
                ...
                if (!local && t.fallbackName() != null) {
                    com.sayonora.warp.core.BackendTarget fallback = backendRegistry.get(t.fallbackName());
                    if (fallback != null) {
                        var lag = com.sayonora.warp.core.ReplicationLag.awaitLagBelow(fallback, 0.0, graceMs);
                ...
                com.sayonora.warp.core.BackendTarget t = requireBackend(backendRegistry, undrainMatch.group(1), response);
                if (t == null) return;
                boolean local = "true".equals(request.getParameter("local"));
                backendRegistry.setState(t.name(), com.sayonora.warp.core.BackendRegistry.BackendState.ACTIVE);
                java.util.List<String> peerResults = local ? java.util.List.of()
                        : fanOutToPeers(options, selfAdminPort, forwardedAuthHeader,
                ...
                com.sayonora.warp.core.BackendTarget t = requireBackend(backendRegistry, tablesMatch.group(1), response);
                if (t == null) return;
                StringBuilder json = new StringBuilder("[");
                boolean first = true;
                for (var table : com.sayonora.warp.core.DataExplorer.listTables(t)) {
                    if (!first) json.append(',');
                    first = false;
                ...
                com.sayonora.warp.core.BackendTarget t = requireBackend(backendRegistry, columnsMatch.group(1), response);
                if (t == null) return;
                StringBuilder json = new StringBuilder("[");
                boolean first = true;
                for (var col : com.sayonora.warp.core.DataExplorer.listColumns(t, columnsMatch.group(2), columnsMatch.group(3))) {
                    if (!first) json.append(',');
                    first = false;
                ...
                com.sayonora.warp.core.BackendTarget t = requireBackend(backendRegistry, queryMatch.group(1), response);
                if (t == null) return;
                JsonObject body = readJsonBody(request);
                if (!body.has("sql") || body.get("sql").getAsString().isBlank()) {
                    throw new IllegalArgumentException("sql is required");
                }
                var result = com.sayonora.warp.core.DataExplorer.runQuery(t, body.get("sql").getAsString());
    ...
    private static com.sayonora.warp.core.BackendTarget requireBackend(com.sayonora.warp.core.BackendRegistry backendRegistry,
            String name, HttpServletResponse response) throws java.io.IOException {
        com.sayonora.warp.core.BackendTarget t = backendRegistry.get(name);
        if (t == null) {
            response.setStatus(HttpServletResponse.SC_NOT_FOUND);
     ...
     * {@link com.sayonora.warp.config.NodeRegistry#listAll} (the same table the {@code /api/nodes}
     ...
     */
    private static java.util.List<String> fanOutToPeers(com.sayonora.warp.server.ServerOptions options,
            int selfAdminPort, String authHeader, String path) {
        java.util.List<String> results = new java.util.ArrayList<>();
        if (options == null) {
            return results;
        }
        java.util.List<com.sayonora.warp.config.NodeRegistry.NodeRow> nodes;
        try {
            nodes = com.sayonora.warp.config.NodeRegistry.listAll(options);
        } catch (java.sql.SQLException e) {
            results.add("ERROR: could not list cluster nodes to fan out to: " + e.getMessage());
            return results;
        }
        String selfHost = com.sayonora.warp.config.NodeRegistry.resolveHost();
     ...
     * {@link com.sayonora.warp.capture.WorkloadCaptureBuffer}, oldest-first, {@code localSeq}
     ...
     * the fleet -- see {@link com.sayonora.warp.capture.WorkloadCaptureBuffer}'s javadoc.
     */
    private static void handleCapture(HttpServletRequest request, HttpServletResponse response,
            com.sayonora.warp.capture.WorkloadCaptureBuffer captureBuffer) throws java.io.IOException {
        response.setContentType("application/json; charset=utf-8");
        if (!"GET".equals(request.getMethod())) {
            response.setStatus(HttpServletResponse.SC_NOT_FOUND);
            response.getWriter().write("{\"error\":\"no such route\"}");
        ...
        StringBuilder json = new StringBuilder("[");
        boolean first = true;
        for (com.sayonora.warp.capture.WorkloadCaptureBuffer.Entry e : captureBuffer.since(since, limit)) {
            if (!first) json.append(',');
            first = false;
     ...
     * buffer otherwise (see {@link com.sayonora.warp.audit.AuditLog#recent}). */
    private static void handleAudit(HttpServletRequest request, HttpServletResponse response,
            com.sayonora.warp.audit.AuditLog auditLog) throws java.io.IOException {
        response.setContentType("application/json; charset=utf-8");
        if (!"GET".equals(request.getMethod())) {
            response.setStatus(HttpServletResponse.SC_NOT_FOUND);
            response.getWriter().write("{\"error\":\"no such route\"}");
        ...
        StringBuilder json = new StringBuilder("[");
        boolean first = true;
        for (com.sayonora.warp.audit.AuditEvent event : auditLog.recent(limit)) {
            if (!first) json.append(',');
            first = false;
            json.append(com.sayonora.warp.audit.AuditLog.toJson(event));
        }
        json.append(']');
        response.setStatus(HttpServletResponse.SC_OK);
        response.getWriter().write(json.toString());
     ...
     * {@link com.sayonora.warp.audit.AuditLog#recent}, which returns EVERY event type most-recent-
    ...
    private static void handleMcpAuditSummarize(HttpServletRequest request, HttpServletResponse response,
            com.sayonora.warp.audit.AuditLog auditLog, com.sayonora.warp.core.DialectTranslationStage dialectTranslationStage)
            throws java.io.IOException {
        response.setContentType("application/json; charset=utf-8");
        com.sayonora.warp.core.TranslationLlmClient llmClient =
                dialectTranslationStage == null ? null : dialectTranslationStage.llmClient();
        ...
        java.util.List<com.sayonora.warp.audit.AuditEvent> matched = new java.util.ArrayList<>();
        for (com.sayonora.warp.audit.AuditEvent event : auditLog.recent(Math.min(limit * 10, 2000))) {
            if (event.type() != com.sayonora.warp.audit.AuditEvent.Type.MCP_TOOL_CALLED) {
                continue;
            }
        ...
        StringBuilder context = new StringBuilder();
        for (com.sayonora.warp.audit.AuditEvent event : matched) {
     ...
     * {@code warp_nodes} (see {@link com.sayonora.warp.config.NodeRegistry}). Sorted by zone
    ...
    private static void handleNodes(HttpServletRequest request, HttpServletResponse response,
            com.sayonora.warp.server.ServerOptions options) throws java.io.IOException {
        response.setContentType("application/json; charset=utf-8");
        if (!"GET".equals(request.getMethod())) {
            response.setStatus(HttpServletResponse.SC_NOT_FOUND);
            response.getWriter().write("{\"error\":\"no such route\"}");
        ...
        try {
            StringBuilder json = new StringBuilder("[");
            boolean first = true;
            for (com.sayonora.warp.config.NodeRegistry.NodeRow row : com.sayonora.warp.config.NodeRegistry.listAll(options)) {
                if (!first) json.append(',');
                first = false;
    ...
    private static String renderAnomalies(com.sayonora.warp.core.AnomalyDetectionScheduler anomalyScheduler) {
    ...
    private static String renderMetricsSummary(StatsCollectorStage statsStage,
        ...
        com.sayonora.warp.core.SqlMetricsCollector.Snapshot snap = statsStage.sqlMetricsSnapshot();
        StringBuilder json = new StringBuilder("{");
