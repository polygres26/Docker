 ...
 * com.sayonora.warp.core.connector.ConnectorOperands}, see its javadoc for the text grammar):
 * <pre>{@code
 ...
 * com.sayonora.warp.core.connector.ConnectorOperands} enforces this at the config grammar level (a
...
public final class S3SchemaFactory implements SchemaFactory {
    ...
    public static software.amazon.awssdk.services.s3.S3Client openClient(Map<String, Object> operand) {
        return S3CompatibleObjectFetcher.buildClient(stringOrNull(operand, "region"),
                ...
                com.sayonora.warp.secrets.SecretResolver.resolve(stringOrNull(operand, "secretAccessKey")));
    }
    ...
    private static ObjectFetcher buildFetcher(String bucket, Map<String, Object> operand) {
        ...
        String secretAccessKey = com.sayonora.warp.secrets.SecretResolver.resolve(stringOrNull(operand, "secretAccessKey"));
