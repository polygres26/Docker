 ...
 * entry by {@link com.sayonora.warp.core.connector.ConnectorOperands}, see its javadoc for the text
 * grammar):
 * <pre>{@code
...
public final class CassandraSchemaFactory implements SchemaFactory {
    ...
    public static CqlSession buildSession(Map<String, Object> operand) {
        ...
        String password = com.sayonora.warp.secrets.SecretResolver.resolve(stringOrNull(operand, "password"));
