...
public final class TranslationLlmClient {
     ...
     * {@link com.sayonora.warp.config.WarpConfig#llmProvider()} et al.), falling back to the
     ...
     * between two known dialects -- see {@link com.sayonora.warp.core.QueryRepairStage}'s own
     ...
     * com.sayonora.warp.audit.AuditEvent} rows, not invented -- this method only phrases what's
