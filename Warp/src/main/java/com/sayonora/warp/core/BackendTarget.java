 ...
 *     com.sayonora.warp.core.connector.ConnectorOperands#parse} built from this target's own
...
public record BackendTarget(String name, String jdbcUrl, String user, String password,
        com.sayonora.warp.server.ServerOptions failoverOptions, String fallbackName,
    ...
    public BackendTarget(String name, String jdbcUrl, String user, String password,
            com.sayonora.warp.server.ServerOptions failoverOptions) {
     ...
     * see {@link com.sayonora.warp.pgwire.PgConnections#openForRead}. Falls back to {@link #open()}
    ...
    public Connection openPreferringStandby() throws SQLException {
        ...
        Connection connection = com.sayonora.warp.pgwire.PgConnections.openForRead(failoverOptions);
        connection.setAutoCommit(true);
        return connection;
    }
    ...
    private Connection borrow() throws SQLException {
        ...
        if (failoverOptions != null) {
            return com.sayonora.warp.pgwire.PgConnections.open(failoverOptions);
        }
        ...
        String resolvedPassword = com.sayonora.warp.secrets.SecretResolver.resolve(password);
