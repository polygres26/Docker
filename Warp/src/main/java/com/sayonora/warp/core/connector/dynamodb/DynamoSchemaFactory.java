 ...
 * entry by {@link com.sayonora.warp.core.connector.ConnectorOperands}, see its javadoc for the
 * text grammar):
 * <pre>{@code
 ...
 * (Same reasoning as {@link com.sayonora.warp.core.connector.mongo.MongoTable}'s javadoc, which has
 * the full version.)
 *
