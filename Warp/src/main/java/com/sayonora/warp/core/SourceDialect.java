...
public enum SourceDialect {
     ...
     * com.sayonora.warp.core.connector.dynamodb.DynamoSchemaFactory}. Never a translation target
     ...
     * com.sayonora.warp.core.connector.mongo.MongoSchemaFactory}. */
    MONGODB,
    /** A real S3 (or S3-compatible: MinIO/Wasabi/etc.) object exposed as a federated table -- see
     * {@link com.sayonora.warp.core.connector.s3.S3SchemaFactory}. Federation-only, same as {@link
     * #DYNAMODB}/{@link #MONGODB}: no JDBC driver exists for object storage. */
    S3,
    /** A real Kafka topic read as a bounded snapshot -- see {@link
     * com.sayonora.warp.core.connector.kafka.KafkaSchemaFactory}. Federation-only. */
    KAFKA,
    /** A real Cassandra table -- see {@link
     * com.sayonora.warp.core.connector.cassandra.CassandraSchemaFactory}. Federation-only. A plain
     ...
     * com.sayonora.warp.core.connector.splunk.SplunkSchemaFactory}. Federation-only. */
    SPLUNK,
    /**
