package com.sayonora.warp.mssqlwire.frontend;
...
public final class TdsTokens {
    ...
    private static boolean isBinaryColumn(com.sayonora.warp.core.ColumnInfo column) {
     ...
     */
    public static void writeColMetaData(ByteArrayOutputStream out, List<com.sayonora.warp.core.ColumnInfo> columns) {
        out.write(TOKEN_COLMETADATA);
        writeU16LE(out, columns.size());
        for (com.sayonora.warp.core.ColumnInfo column : columns) {
            writeU32LE(out, 0);
            writeU16LE(out, 0);
    ...
    public static void writeRow(ByteArrayOutputStream out, List<Object> values, List<com.sayonora.warp.core.ColumnInfo> columns) {
        out.write(TOKEN_ROW);
