...
import com.sayonora.warp.bigtablewire.admin.v2.CheckConsistencyRequest;
import com.sayonora.warp.bigtablewire.admin.v2.CheckConsistencyResponse;
import com.sayonora.warp.bigtablewire.admin.v2.CreateTableRequest;
import com.sayonora.warp.bigtablewire.admin.v2.DeleteTableRequest;
import com.sayonora.warp.bigtablewire.admin.v2.DropRowRangeRequest;
import com.sayonora.warp.bigtablewire.admin.v2.GenerateConsistencyTokenRequest;
import com.sayonora.warp.bigtablewire.admin.v2.GenerateConsistencyTokenResponse;
import com.sayonora.warp.bigtablewire.admin.v2.GetTableRequest;
import com.sayonora.warp.bigtablewire.admin.v2.ListTablesRequest;
import com.sayonora.warp.bigtablewire.admin.v2.ListTablesResponse;
import com.sayonora.warp.bigtablewire.admin.v2.ModifyColumnFamiliesRequest;
import com.sayonora.warp.bigtablewire.admin.v2.Table;
import com.sayonora.warp.bigtablewire.admin.v2.UpdateTableRequest;
import com.sayonora.warp.bigtablewire.v2.BigtableGrpc;
import com.sayonora.warp.bigtablewire.v2.CheckAndMutateRowRequest;
import com.sayonora.warp.bigtablewire.v2.CheckAndMutateRowResponse;
import com.sayonora.warp.bigtablewire.v2.MutateRowRequest;
import com.sayonora.warp.bigtablewire.v2.MutateRowResponse;
import com.sayonora.warp.bigtablewire.v2.MutateRowsRequest;
import com.sayonora.warp.bigtablewire.v2.MutateRowsResponse;
import com.sayonora.warp.bigtablewire.v2.PingAndWarmRequest;
import com.sayonora.warp.bigtablewire.v2.PingAndWarmResponse;
import com.sayonora.warp.bigtablewire.v2.ReadModifyWriteRowRequest;
import com.sayonora.warp.bigtablewire.v2.ReadModifyWriteRowResponse;
import com.sayonora.warp.bigtablewire.v2.ReadRowsRequest;
import com.sayonora.warp.bigtablewire.v2.ReadRowsResponse;
import com.sayonora.warp.bigtablewire.v2.SampleRowKeysRequest;
import com.sayonora.warp.bigtablewire.v2.SampleRowKeysResponse;
