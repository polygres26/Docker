...
import com.sayonora.warp.core.PipelineChain;
...
public final class CacheStage implements PipelineStage {
    ...
    // Set post-construction by Main -- the shared com.sayonora.warp.core.SqlMetricsCollector
    ...
    private volatile com.sayonora.warp.core.SqlMetricsCollector sqlMetrics;
        ...
        if (cachedBytes != null) {
            ...
            if (sqlMetrics != null) {
                sqlMetrics.recordRttOutcome(com.sayonora.warp.core.SqlMetricsCollector.protocolName(statement.sourceDialect()),
                        com.sayonora.warp.core.SqlMetricsCollector.OUTCOME_CACHE_HIT, elapsedNanos);
            }
    ...
    public void setSqlMetrics(com.sayonora.warp.core.SqlMetricsCollector sqlMetrics) {
