...
ALL_LISTEN_PORT_VARS = [
    ...
    "WARP_AZBLOBWIRE_PORT", "WARP_AZQUEUEWIRE_PORT", "WARP_AZTABLEWIRE_PORT", "WARP_GCSWIRE_PORT", "WARP_BIGTABLEWIRE_PORT", "WARP_PUBSUBWIRE_PORT", "WARP_PUBSUBWIRE_REST_PORT", "WARP_FIRESTOREWIRE_PORT", "WARP_DATASTOREWIRE_PORT"]
