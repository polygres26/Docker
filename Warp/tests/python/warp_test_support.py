...
ALL_LISTEN_PORT_VARS = [
    ...
    "WARP_MYWIRE_PORT", "WARP_ORAWIRE_PORT", "WARP_MSSQLWIRE_PORT", "WARP_REDISWIRE_PORT", "WARP_AZBLOBWIRE_PORT",
    "WARP_AZQUEUEWIRE_PORT", "WARP_AZTABLEWIRE_PORT", "WARP_GCSWIRE_PORT", "WARP_BIGTABLEWIRE_PORT", "WARP_PUBSUBWIRE_PORT",
    "WARP_PUBSUBWIRE_REST_PORT", "WARP_FIRESTOREWIRE_PORT", "WARP_DATASTOREWIRE_PORT", "WARP_CQLWIRE_PORT", "WARP_GREMLINWIRE_PORT",
    "WARP_COSMOSWIRE_PORT", "WARP_KAFKAWIRE_PORT", "WARP_AMQPWIRE_PORT"]
...
class WarpProcess:
    ...
    def __init__(self, postgres: RealPostgres, frontend_env_var: str, frontend_name="frontend",
        ...
        if not os.path.exists(JAR_PATH):
            raise RuntimeError(
                f"{JAR_PATH} not found -- run `mvn -DskipTests package` in Warp/ before these tests")
