...
ALL_LISTEN_PORT_VARS = [
    ...
    "WARP_MYWIRE_PORT", "WARP_ORAWIRE_PORT", "WARP_MSSQLWIRE_PORT", "WARP_REDISWIRE_PORT",
    "WARP_AZBLOBWIRE_PORT", "WARP_AZQUEUEWIRE_PORT", "WARP_AZTABLEWIRE_PORT", "WARP_GCSWIRE_PORT", "WARP_BIGTABLEWIRE_PORT", "WARP_PUBSUBWIRE_PORT", "WARP_PUBSUBWIRE_REST_PORT", "WARP_FIRESTOREWIRE_PORT", "WARP_DATASTOREWIRE_PORT", "WARP_CQLWIRE_PORT", "WARP_GREMLINWIRE_PORT", "WARP_COSMOSWIRE_PORT"]
