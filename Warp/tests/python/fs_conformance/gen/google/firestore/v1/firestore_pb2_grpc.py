...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in google/firestore/v1/firestore_pb2_grpc.py depends on'
...
class FirestoreStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ExecutePipeline = channel.unary_stream(
                ...
                request_serializer=google_dot_firestore_dot_v1_dot_firestore__pb2.ExecutePipelineRequest.SerializeToString,
                response_deserializer=google_dot_firestore_dot_v1_dot_firestore__pb2.ExecutePipelineResponse.FromString,
                _registered_method=True)
        self.RunAggregationQuery = channel.unary_stream(
                '/google.firestore.v1.Firestore/RunAggregationQuery',
                request_serializer=google_dot_firestore_dot_v1_dot_firestore__pb2.RunAggregationQueryRequest.SerializeToString,
                response_deserializer=google_dot_firestore_dot_v1_dot_firestore__pb2.RunAggregationQueryResponse.FromString,
                _registered_method=True)
...
def add_FirestoreServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ExecutePipeline': grpc.unary_stream_rpc_method_handler(
                    ...
                    request_deserializer=google_dot_firestore_dot_v1_dot_firestore__pb2.ExecutePipelineRequest.FromString,
                    response_serializer=google_dot_firestore_dot_v1_dot_firestore__pb2.ExecutePipelineResponse.SerializeToString,
            ),
            'RunAggregationQuery': grpc.unary_stream_rpc_method_handler(
                    servicer.RunAggregationQuery,
                    request_deserializer=google_dot_firestore_dot_v1_dot_firestore__pb2.RunAggregationQueryRequest.FromString,
                    response_serializer=google_dot_firestore_dot_v1_dot_firestore__pb2.RunAggregationQueryResponse.SerializeToString,
            ),
    ...
    server.add_registered_method_handlers('google.firestore.v1.Firestore', rpc_method_handlers)
...
class Firestore(object):
    ...
    def ExecutePipeline(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/google.firestore.v1.Firestore/ExecutePipeline',
            google_dot_firestore_dot_v1_dot_firestore__pb2.ExecutePipelineRequest.SerializeToString,
            google_dot_firestore_dot_v1_dot_firestore__pb2.ExecutePipelineResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def RunAggregationQuery(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/google.firestore.v1.Firestore/RunAggregationQuery',
            google_dot_firestore_dot_v1_dot_firestore__pb2.RunAggregationQueryRequest.SerializeToString,
            google_dot_firestore_dot_v1_dot_firestore__pb2.RunAggregationQueryResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
