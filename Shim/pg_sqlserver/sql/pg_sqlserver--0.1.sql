...
-- Shim extension collection). Companion to Shim/pg_oracle and
-- Shim/pg_mysql, activated the same way: `SET db_emulation = 'sqlserver'`
...
-- Shim/pg_oracle/src/pg_oracle.c's own header comment for the full
...
--
-- Scope, stated plainly, mirroring Shim/pg_oracle and Shim/pg_mysql's own
