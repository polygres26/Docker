package com.nexagres.advisor.secrets;
...
/**
 * Resolves a {@link SecretRef} to its actual value at connect time -- see PolyWire's
 * {@code com.nexagres.wire.secrets.SecretResolver} for the twin implementation this was ported
 * from (same behavior: opt-in via env vars, fails loud rather than silently trying an empty
 * password).
 */
