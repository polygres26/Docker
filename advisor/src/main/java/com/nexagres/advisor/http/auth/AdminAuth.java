package com.nexagres.advisor.http.auth;
 ...
 *
 * <p>Credentials: {@code NEXAGRES_ADMIN_USER} (default {@code admin}) and
...
public class AdminAuth {
    ...
    public AdminAuth() {
        this.adminUser = System.getenv().getOrDefault("NEXAGRES_ADMIN_USER", "admin");
        String configured = System.getenv("NEXAGRES_ADMIN_PASSWORD");
