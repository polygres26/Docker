 ...
 * com.nexagres.advisor.score.MigrationScorer} et al.) -- there's no live database to query
 ...
 * {@link com.nexagres.advisor.sizing.SizingCalculator} for the report-based sizing flow, the same
