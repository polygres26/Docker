 ...
 *
 * <p>Same plaintext-at-rest caveat as {@link com.nexagres.advisor.core.ConnectionRecord}: {@code
...
public class LlmSettings {
     ...
     * NEXAGRES_LLM_LOCAL_SERVER_PATH, so it isn't required here -- see LocalLlamaManager).
