...
Montdb.com's Polygres project: two independent, sibling Java/Maven modules in this repo, each
...
- **[advisor/](advisor/README.md)** -- Polygres Advisor: migration assessment and migration tool.
...
- **[wire/](wire/)** -- PolyWire: a mid-tier, Postgres-only database gateway. Speaks Oracle TNS/
  ...
  from Omnigate (`~/Projects/Omnigate`, package `com.omnigate.*` -> `com.polygres.wire.*`).
