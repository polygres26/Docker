 ...
 * operator-provided (the server binary via {@code POLYGRES_LLM_LOCAL_SERVER_PATH}, defaulting to
...
public final class LocalLlamaProcess implements AutoCloseable {
    ...
    public static LocalLlamaProcess start(String serverPath, String modelPath, int port) throws IOException {
        ...
        builder.redirectOutput(ProcessBuilder.Redirect.appendTo(java.io.File.createTempFile("polygres-llama-", ".log")));
