...
/**
 * Configures NexaGate's SQL-dialect-translation LLM fallback. NexaGate always tries a fast
  ...
  return (
    <div style={{ maxWidth: 560 }}>
      ...
      <p style={{ color: 'var(--muted)', fontSize: 13, marginTop: 0, marginBottom: 20 }}>
        NexaGate translates SQL between dialects with a fast, deterministic AST-based rewriter
        first. Only statements that rewriter can't handle fall back to an LLM call -- so this is a
        <strong> coverage setting for the long tail</strong>, not NexaGate's primary translation
