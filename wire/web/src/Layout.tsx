...
// of the three groups matching the questions someone actually has when they open Warp's admin
 ...
 * Layout but scoped to Warp alone -- there's no Migration/Advisor product sharing this rail. */
    ...
    <div className={styles.shell}>
      <nav className={styles.rail}>
        <div className={styles.railBrand}>
          ...
          <div className={styles.railBrandText}>
            <span className={styles.railBrandTitle}>Warp</span>
      ...
      <div className={styles.main}>
        <div className={styles.topbar}>
          <div className={styles.crumb}>warp admin</div>
        </div>
