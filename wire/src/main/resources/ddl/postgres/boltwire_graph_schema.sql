...
-- docs/POLYWIRE_GUIDE.md's own backend-engine prerequisites section).
-- ### nodes_table
CREATE TABLE IF NOT EXISTS polywire_graph_nodes (
    id BIGSERIAL PRIMARY KEY,
    labels TEXT[] NOT NULL DEFAULT '{}',
    properties JSONB NOT NULL DEFAULT '{}'
)
-- ### nodes_labels_index
CREATE INDEX IF NOT EXISTS polywire_graph_nodes_labels_idx ON polywire_graph_nodes USING GIN (labels)
-- ### nodes_properties_index
CREATE INDEX IF NOT EXISTS polywire_graph_nodes_props_idx ON polywire_graph_nodes USING GIN (properties)
-- ### edges_table
CREATE TABLE IF NOT EXISTS polywire_graph_edges (
    id BIGSERIAL PRIMARY KEY,
    type TEXT NOT NULL,
...
-- ### edges_from_index
CREATE INDEX IF NOT EXISTS polywire_graph_edges_from_idx ON polywire_graph_edges (from_id)
-- ### edges_to_index
CREATE INDEX IF NOT EXISTS polywire_graph_edges_to_idx ON polywire_graph_edges (to_id)
-- ### edges_type_index
CREATE INDEX IF NOT EXISTS polywire_graph_edges_type_idx ON polywire_graph_edges (type)
