...
public final class WarpGrpcServer {
    ...
    private final com.sayonora.wire.acl.ConnectionGate connectionGate;
    ...
    public WarpGrpcServer(ServerOptions options, List<PipelineStage> sharedStages,
        ...
        this(options, sharedStages, backendRegistry, com.sayonora.wire.acl.ConnectionGate.DISABLED);
    }
