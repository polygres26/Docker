package com.sayonora.wire.telemetry;
...
public final class WarpTelemetry {
    ...
    private WarpTelemetry(String protocol, String otlpEndpoint, long exportIntervalMs,
        ...
        SdkMeterProvider meterProvider = SdkMeterProvider.builder()
                .registerMetricReader(PeriodicMetricReader.builder(exporter)
                        ...
                        .build())
                .build();
        Meter meter = meterProvider.meterBuilder("com.sayonora.wire").setInstrumentationVersion("0.1.0").build();
     ...
     * com.sayonora.wire.core.SqlMetricsCollector} as async OTel gauges, reporting whatever {@code
     ...
     */
    public void attachSqlMetrics(java.util.function.Supplier<com.sayonora.wire.core.SqlMetricsCollector.Snapshot> snapshotSupplier) {
