...
public final class DialectTranslations {
    ...
    // own TO_DATE() fidelity fix (db/pg_oracle/sql/pg_oracle--0.1.sql) -- same underlying gap,
    ...
    // specifically to preserve Oracle DATE's time component, see db/pg_oracle's own comment on
