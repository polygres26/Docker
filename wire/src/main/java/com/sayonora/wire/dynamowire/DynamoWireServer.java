...
public final class DynamoWireServer {
    ...
    public DynamoWireServer(int port, String pgHost, int pgPort, String pgDatabase, String pgUser, String pgPassword,
            com.sayonora.wire.cluster.RowCache cache) {
        this(port, pgHost, pgPort, pgDatabase, pgUser, pgPassword, cache, com.sayonora.wire.acl.ConnectionGate.DISABLED);
    }

    public DynamoWireServer(int port, String pgHost, int pgPort, String pgDatabase, String pgUser, String pgPassword,
            com.sayonora.wire.cluster.RowCache cache, com.sayonora.wire.acl.ConnectionGate connectionGate) {
        this(port, pgHost, pgPort, pgDatabase, pgUser, pgPassword, cache, connectionGate,
                ...
                com.sayonora.wire.dynamowire.auth.AwsIamCredentialStore.DISABLED);
    }
     ...
     */
    public DynamoWireServer(int port, com.sayonora.wire.core.BackendRegistry backendRegistry, com.sayonora.wire.cluster.RowCache cache,
    ...
    private DynamoWireServer(int port, PgItemStore store, com.sayonora.wire.cluster.RowCache cache,
            com.sayonora.wire.acl.ConnectionGate connectionGate,
            com.sayonora.wire.http.auth.AccessContextResolver oauth,
            com.sayonora.wire.dynamowire.auth.AwsIamCredentialStore awsIamCredentials,
            com.sayonora.wire.core.SqlMetricsCollector sqlMetrics) {
        ...
        server.setHandler(new AbstractHandler() {
            ...
            public void handle(String target, Request baseRequest, HttpServletRequest request, HttpServletResponse response) throws IOException {
                ...
                if (awsIamCredentials.isEnabled()) {
                    com.sayonora.wire.dynamowire.auth.SigV4Verifier.Result sigResult = sigV4Verifier.verify(request, body);
                    if (!sigResult.valid()) {
