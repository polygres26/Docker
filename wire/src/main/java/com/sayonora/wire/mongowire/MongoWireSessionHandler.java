...
public final class MongoWireSessionHandler implements Runnable {
    ...
    public MongoWireSessionHandler(Socket clientSocket, String pgUrl, String pgUser, String pgPassword, com.sayonora.wire.cluster.RowCache cache) {
     ...
     */
    public MongoWireSessionHandler(Socket clientSocket, com.sayonora.wire.core.BackendRegistry backendRegistry,
            com.sayonora.wire.cluster.RowCache cache, com.sayonora.wire.core.SqlMetricsCollector sqlMetrics) {
        this.clientSocket = clientSocket;
