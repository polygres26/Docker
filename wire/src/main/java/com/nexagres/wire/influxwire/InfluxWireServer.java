...
public final class InfluxWireServer {
    ...
    public InfluxWireServer(int port, com.nexagres.wire.core.BackendRegistry backendRegistry) {
    ...
    private void handleWrite(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            response.setStatus(204);
            recordMetric("write", com.nexagres.wire.core.SqlMetricsCollector.StatementKind.WRITE, db, start);
    ...
    private void handleQuery(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            recordMetric("query", com.nexagres.wire.core.SqlMetricsCollector.StatementKind.READ, db, start);
        } catch (SQLException e) {
    ...
    private void recordMetric(String operation, com.nexagres.wire.core.SqlMetricsCollector.StatementKind kind,
        ...
        if (sqlMetrics != null) {
            ...
            String outcome = kind == com.nexagres.wire.core.SqlMetricsCollector.StatementKind.READ
                    ? com.nexagres.wire.core.SqlMetricsCollector.OUTCOME_PG_READ
                    : com.nexagres.wire.core.SqlMetricsCollector.OUTCOME_PG_WRITE;
