...
public final class OpenSearchWireServer {
    ...
    public OpenSearchWireServer(int port, com.nexagres.wire.core.BackendRegistry backendRegistry) {
        this(port, backendRegistry, com.nexagres.wire.acl.ConnectionGate.DISABLED,
                com.nexagres.wire.http.auth.AccessContextResolver.DISABLED, null);
    }
    ...
    private void handleSearch(HttpServletRequest request, HttpServletResponse response, String index) throws IOException {
        ...
        try {
            ...
            recordMetric("_search", com.nexagres.wire.core.SqlMetricsCollector.StatementKind.READ, index, start);
    ...
    private void handleIndexDoc(HttpServletRequest request, HttpServletResponse response, String index, String id)
        ...
        try {
            ...
            recordMetric("_doc", com.nexagres.wire.core.SqlMetricsCollector.StatementKind.WRITE, index, start);
        } catch (SQLException e) {
            writeError(response, OpenSearchErrorMapper.status(e.getSQLState()), OpenSearchErrorMapper.errorType(e.getSQLState()), e.getMessage());
        } catch (RuntimeException e) {
            writeError(response, 400, "parsing_exception", String.valueOf(e.getMessage()));
    ...
    private void handleGetDoc(HttpServletResponse response, String index, String id) throws IOException {
        ...
        try {
            ...
            recordMetric("_doc", com.nexagres.wire.core.SqlMetricsCollector.StatementKind.READ, index, start);
        } catch (SQLException e) {
            writeError(response, OpenSearchErrorMapper.status(e.getSQLState()), OpenSearchErrorMapper.errorType(e.getSQLState()), e.getMessage());
        }
    }
    ...
    private void handleBulk(HttpServletRequest request, HttpServletResponse response, String defaultIndex) throws IOException {
        ...
        writeJson(response, 200, resp);
        recordMetric("_bulk", com.nexagres.wire.core.SqlMetricsCollector.StatementKind.WRITE,
     ...
     */
    private void recordMetric(String operation, com.nexagres.wire.core.SqlMetricsCollector.StatementKind kind,
        ...
        if (sqlMetrics != null) {
            ...
            String outcome = switch (kind) {
                case READ -> com.nexagres.wire.core.SqlMetricsCollector.OUTCOME_PG_READ;
                case WRITE -> com.nexagres.wire.core.SqlMetricsCollector.OUTCOME_PG_WRITE;
                case OTHER -> null;
            };
            if (outcome != null) {
