...
public final class DynamoWireServer {
    ...
    private DynamoWireServer(int port, PgItemStore store, com.nexagres.wire.cluster.RowCache cache,
        ...
        com.nexagres.wire.dynamowire.auth.SigV4Verifier sigV4Verifier =
                new com.nexagres.wire.dynamowire.auth.SigV4Verifier(awsIamCredentials);
        ...
        server.setHandler(new AbstractHandler() {
            ...
            public void handle(String target, Request baseRequest, HttpServletRequest request, HttpServletResponse response) throws IOException {
                ...
                if (awsIamCredentials.isEnabled()) {
                    com.nexagres.wire.dynamowire.auth.SigV4Verifier.Result sigResult = sigV4Verifier.verify(request, body);
                    if (!sigResult.valid()) {
