...
import com.nexagres.wire.orawire.frontend.ConnectHandshake;
import com.nexagres.wire.orawire.frontend.ProtocolNegotiation;
import com.nexagres.wire.auth.CredentialStore;
import com.nexagres.wire.orawire.frontend.auth.O5LogonHandler;
...
public final class SessionHandler implements Runnable {
    ...
    public void run() {
        ...
        if (options.dualExecEnabled()
            ...
            try (Socket socket = clientSocket) {
                com.nexagres.wire.orawire.backend.NativeSessionRelay.relay(
        ...
        try (Socket socket = clientSocket) {
            ...
            if (reader.isAnoEligible()) {
                ...
                new com.nexagres.wire.orawire.frontend.AnoNegotiation().perform(reader, out);
            }
            ...
            if (!auth.success()) {
                ...
                if (auditLog != null) {
                    auditLog.record(com.nexagres.wire.audit.AuditEvent.of(
                            com.nexagres.wire.audit.AuditEvent.Type.DB_LOGIN_FAILED, auth.username(),
            ...
            if (auditLog != null) {
                auditLog.record(com.nexagres.wire.audit.AuditEvent.of(
                        com.nexagres.wire.audit.AuditEvent.Type.DB_LOGIN_SUCCEEDED, auth.username(),
            ...
            com.nexagres.wire.core.AccessContext accessContext = auth.realIdentity()
    ...
    private void runPlain(TnsPacketReader reader, OutputStream out, ConnectDescriptor descriptor,
            O5LogonHandler.AuthResult auth, com.nexagres.wire.core.AccessContext accessContext) throws Exception {
        try (com.nexagres.wire.core.LazyPooledConnection pgConnection = backendPool.borrowConnection(descriptor, auth.username())) {
    ...
    private void runReplicated(TnsPacketReader reader, OutputStream out, ConnectDescriptor descriptor,
            ...
            com.nexagres.wire.core.AccessContext accessContext) throws Exception {
