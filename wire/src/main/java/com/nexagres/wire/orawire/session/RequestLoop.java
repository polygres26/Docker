package com.nexagres.wire.orawire.session;

import com.nexagres.wire.config.FailedStatementLog;
import com.nexagres.wire.core.ColumnInfo;
...
import com.nexagres.wire.orawire.translator.BindVariableRewriter;
import com.nexagres.wire.xa.XaTransaction;
import com.nexagres.wire.orawire.translator.DualTableRewriter;
import com.nexagres.wire.orawire.ttc.BindParam;
import com.nexagres.wire.orawire.ttc.ColumnMetadata;
import com.nexagres.wire.orawire.ttc.ExecuteRequest;
import com.nexagres.wire.orawire.ttc.ExecuteRequestReader;
import com.nexagres.wire.orawire.ttc.FetchRequest;
import com.nexagres.wire.orawire.ttc.ResponseWriter;
import com.nexagres.wire.orawire.ttc.TtcConstants;
import com.nexagres.wire.orawire.ttc.TtcReader;
import com.nexagres.wire.orawire.ttc.TtcWriter;
import com.nexagres.wire.server.ServerOptions;
import com.nexagres.wire.orawire.wireformat.TnsPacket;
import com.nexagres.wire.orawire.wireformat.TnsPacketReader;
import com.nexagres.wire.orawire.wireformat.TnsPacketType;
...
public final class RequestLoop {
    ...
    private final com.nexagres.wire.core.LazyPooledConnection pgConnection;
    private final com.nexagres.wire.core.LazyPooledConnection oracleConnection;
    ...
    private com.nexagres.wire.orawire.backend.NativeOracleExecutor nativeExecutor;
    ...
    public RequestLoop(TnsPacketReader reader, OutputStream out, com.nexagres.wire.core.LazyPooledConnection pgConnection,
            com.nexagres.wire.core.LazyPooledConnection oracleConnection, List<Connection> replicaConnections,
            XaTransaction xaTransaction,
            ServerOptions options, List<PipelineStage> sharedStages, com.nexagres.wire.core.BackendRegistry backendRegistry) {
        this(reader, out, pgConnection, oracleConnection, replicaConnections, xaTransaction, options, sharedStages,
                backendRegistry, null, null, com.nexagres.wire.core.AccessContext.ANONYMOUS);
    }
    ...
    public RequestLoop(TnsPacketReader reader, OutputStream out, com.nexagres.wire.core.LazyPooledConnection pgConnection,
        ...
        this(reader, out, pgConnection, oracleConnection, replicaConnections, xaTransaction, options, sharedStages,
                backendRegistry, oracleUsername, oraclePassword, com.nexagres.wire.core.AccessContext.ANONYMOUS);
    }
    ...
    public RequestLoop(TnsPacketReader reader, OutputStream out, com.nexagres.wire.core.LazyPooledConnection pgConnection,
            ...
            XaTransaction xaTransaction,
            ServerOptions options, List<PipelineStage> sharedStages, com.nexagres.wire.core.BackendRegistry backendRegistry,
            String oracleUsername, String oraclePassword, com.nexagres.wire.core.AccessContext accessContext) {
    ...
    private void handleExecuteNative(ExecuteRequest request, TtcWriter w) throws SQLException {
        if (nativeExecutor == null) {
            nativeExecutor = new com.nexagres.wire.orawire.backend.NativeOracleExecutor(
                    options, oracleUsername, oraclePassword);
        }
        com.nexagres.wire.orawire.backend.NativeOracleExecutor.NativeQueryResult result =
