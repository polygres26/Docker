...
public record BackendTarget(String name, String jdbcUrl, String user, String password,
        com.nexagres.wire.server.ServerOptions failoverOptions, String fallbackName) {
    ...
    public BackendTarget(String name, String jdbcUrl, String user, String password,
            com.nexagres.wire.server.ServerOptions failoverOptions) {
     ...
     * see {@link com.nexagres.wire.pgwire.PgConnections#openForRead}. Falls back to {@link #open()}
    ...
    public Connection openPreferringStandby() throws SQLException {
        ...
        Connection connection = com.nexagres.wire.pgwire.PgConnections.openForRead(failoverOptions);
        connection.setAutoCommit(true);
        return connection;
    }
    ...
    private Connection borrow() throws SQLException {
        if (failoverOptions != null) {
            return com.nexagres.wire.pgwire.PgConnections.open(failoverOptions);
        }
        ...
        String resolvedPassword = com.nexagres.wire.secrets.SecretResolver.resolve(password);
