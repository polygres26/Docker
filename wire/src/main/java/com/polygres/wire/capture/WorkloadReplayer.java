package com.polygres.wire.capture;

import com.polygres.wire.config.NodeRegistry;
 ...
 *
 * <p>Run via {@code java -cp polygres-wire.jar com.polygres.wire.capture.WorkloadReplayer}, using
